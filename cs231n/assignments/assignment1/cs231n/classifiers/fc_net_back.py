...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        output1 = np.maximum(0, np.dot(X, W1) + b1)
        ...
        cors = exp_scores[range(num_train), y]
        loss = cors / score_sum
        ...
        s = np.divide(exp_scores, score_sum.reshape(num_train, 1))
        s[range(num_train), y] = - (score_sum - cors) / score_sum
        s /= num_train
        dW2 = output1.T.dot(s)
